...
class DefenderNetworkModel(Model):
    ...
    def __init__(self, num_groups=7, num_members=6, prob_add_friend=0.5, punish = 0, alphaM=45, betaM=45, punish_cost=50, penalty=100):
...
class Defender(Agent):
    ...
    def __init__(self, unique_id, model, prob_add_friend, punish, alphaM, betaM, punish_cost, penalty):
