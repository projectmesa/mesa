"""Bundled SVG icon access helpers for Mesa visualization.

Provides:
- list_icons(): available icon basenames.
- get_icon_svg(name): raw SVG text for the given icon (supports optional 'mesa:<name>' prefix).
"""
