...
- Go though our [Introductory Tutorial](https://mesa.readthedocs.io/latest/examples.html) and [Visualization Tutorial](https://mesa.readthedocs.io/latest/tutorials/visualization_tutorial.html). While going through them, dive into the source code to really see what everything does.
