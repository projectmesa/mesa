...
- Go though our [Introductory Tutorial](https://mesa.readthedocs.io/latest/tutorials/0_first_model.html) and [Visualization Tutorial](https://mesa.readthedocs.io/latest/tutorials/4_visualization_basic.html). While going through them, dive into the source code to really see what everything does.
