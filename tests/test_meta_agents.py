...
def setup_agents():
    ...
    agent4.custom_function = lambda: "custom_function"
...
def test_create_meta_agent_new_class(setup_agents):
    ...
    assert hasattr(meta_agent, "custom_function")
    assert meta_agent.custom_function() == "custom_function"
...
def test_create_meta_agent_existing_class(setup_agents):
    ...
    assert meta_agent2.agents == {agents[1]}
    assert hasattr(meta_agent2, "custom_attribute")
    assert meta_agent2.custom_attribute == "custom_value"
    assert hasattr(meta_agent2, "custom_function")
    assert meta_agent2.custom_function() == "custom_function"
...
def test_add_agents_to_existing_meta_agent(setup_agents):
    ...
    assert meta_agent1.agents == {agents[0], agents[1], agents[2]}
    ...
    assert hasattr(meta_agent1, "custom_function")
    assert meta_agent1.custom_function() == "custom_function"
