...
class TestAltairComponents(TestBaseVisualizationComponents):
    ...
    def test_altair_plot_component(self, mock_model):
        ...
        component = make_altair_plot_component({"data1": "red", "data2": "blue"})
        box, rc = solara.render(component(mock_model), handle_error=False)
        ...
        component_with_custom = make_altair_plot_component(
            {"data1": "red"},
            post_process=post_process
        )
        box, rc = solara.render(component_with_custom(mock_model), handle_error=False)
...
class TestExampleModelVisualizations:
    ...
    def test_conways_game_visualization(self):
        ...
        from mesa.examples.basic.conways_game_of_life.app import agent_portrayal, model_params
    ...
    def test_virus_network_visualization(self):
        ...
        from mesa.examples.basic.virus_on_network.app import agent_portrayal, model_params
    ...
    def test_boltzmann_visualization(self):
        ...
        from mesa.examples.basic.boltzmann_wealth_model.app import agent_portrayal, model_params
        ...
        plot_component = make_altair_plot_component({"Gini": "blue"})
...
class TestPerformanceBenchmarks:
    ...
    def test_rendering_performance(self):
        ...
        print(f"Matplotlib rendering times: small={small_mpl_time:.4f}s, medium={medium_mpl_time:.4f}s, large={large_mpl_time:.4f}s")
        print(f"Altair rendering times: small={small_altair_time:.4f}s, medium={medium_altair_time:.4f}s, large={large_altair_time:.4f}s") 